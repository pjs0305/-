...
/////////////////////////////////////////////////////////////////////////////////////////////////////
//
CBulletMesh::CBulletMesh(float fWidth, float fHeight, float fDepth) : CMesh(6)
{
	float fHalfWidth = fWidth * 0.5f;
	float fHalfHeight = fHeight * 0.5f;
	float fHalfDepth = fDepth * 0.5f;
...
CBulletMesh::~CBulletMesh(void)
{
}

/////////////////////////////////////////////////////////////////////////////////////////////////////
//
CWallMesh::CWallMesh(float fWidth, float fHeight, float fDepth, int nSubRects) : CMesh( 6 * nSubRects * nSubRects )
{
	float fHalfWidth = fWidth * 0.5f;
	float fHalfHeight = fHeight * 0.5f;
	float fHalfDepth = fDepth * 0.5f;
	...
	for (int i = 0; i < nSubRects; i++)
	{
		for (int j = 0; j < nSubRects; j++)
		{
			...
			pFrontFace->SetVertex(0, CVertex(-fHalfWidth + (i*fCellWidth), -fHalfHeight + (j*fCellHeight), fHalfDepth));
			pFrontFace->SetVertex(1, CVertex(-fHalfWidth + ((i + 1)*fCellWidth), -fHalfHeight + (j*fCellHeight), fHalfDepth));
			pFrontFace->SetVertex(2, CVertex(-fHalfWidth + ((i + 1)*fCellWidth), -fHalfHeight + ((j + 1)*fCellHeight), fHalfDepth));
			pFrontFace->SetVertex(3, CVertex(-fHalfWidth + (i*fCellWidth), -fHalfHeight + ((j + 1)*fCellHeight), fHalfDepth));
	...
	for (int i = 0; i < nSubRects; i++)
	{
		for (int j = 0; j < nSubRects; j++)
		{
			...
			pBackFace->SetVertex(0, CVertex(-fHalfWidth + (i*fCellWidth), -fHalfHeight + (j*fCellHeight), -fHalfDepth));
			pBackFace->SetVertex(1, CVertex(-fHalfWidth + ((i + 1)*fCellWidth), -fHalfHeight + (j*fCellHeight), -fHalfDepth));
			pBackFace->SetVertex(2, CVertex(-fHalfWidth + ((i + 1)*fCellWidth), -fHalfHeight + ((j + 1)*fCellHeight), -fHalfDepth));
			pBackFace->SetVertex(3, CVertex(-fHalfWidth + (i*fCellWidth), -fHalfHeight + ((j + 1)*fCellHeight), -fHalfDepth));
