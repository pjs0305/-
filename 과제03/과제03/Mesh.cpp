...
CCubeMeshDiffused::CCubeMeshDiffused(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList*pd3dCommandList, float fWidth, float fHeight, float fDepth, XMFLOAT4 color) : CMesh(pd3dDevice, pd3dCommandList)
{
	//직육면체는 꼭지점(정점)이 8개이다. 
	m_nVertices = 8;
...
CWallMeshDiffused::CWallMeshDiffused(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList*pd3dCommandList, float fWidth, float fHeight, float fDepth) : CMesh(pd3dDevice, pd3dCommandList)
{
	...
	// 앞면
	pnIndices[24] = 3; pnIndices[25] = 2; pnIndices[26] = 7;
	pnIndices[27] = 2; pnIndices[28] = 6; pnIndices[29] = 7;

	// 뒷면
	pnIndices[30] = 0; pnIndices[31] = 4; pnIndices[32] = 1;
	pnIndices[33] = 4; pnIndices[34] = 5; pnIndices[35] = 1;
